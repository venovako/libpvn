...
PVN_EXTERN_C size_t PVN_FABI(pvn_hexify,PVN_HEXIFY)(char *const s, const void *const x, const size_t *const z, const PVN_STRLENF ls);
...
#ifndef _WIN32
PVN_EXTERN_C int PVN_FABI(pvn_whoami,PVN_WHOAMI)(const char **const w);
#endif /* !_WIN32 */
#endif /* !PVN_AUX_H */
