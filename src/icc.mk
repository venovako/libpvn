...
CFLAGS += -std=gnu18 -diag-disable=10397,10441,15519 -fPIC -fexceptions -fp-model precise -fprotect-parens -fma -no-complex-limited-range -no-ftz -prec-div -prec-sqrt -qsimd-honor-fp-model -qsimd-serialize-fp-reduction -qopenmp-simd -pthread -fno-omit-frame-pointer -traceback -xHost #-qopenmp
