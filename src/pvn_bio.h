...
PVN_EXTERN_C int PVN_FABI(pvn_bopen_ro,PVN_BOPEN_RO)(off_t *const sz, const char *const fn, const PVN_STRLENF lfn);
PVN_EXTERN_C int PVN_FABI(pvn_bopen_rw,PVN_BOPEN_RW)(off_t *const sz, const char *const fn, const PVN_STRLENF lfn);
PVN_EXTERN_C int PVN_FABI(pvn_bopen_wo,PVN_BOPEN_WO)(off_t *const sz, const char *const fn, const PVN_STRLENF lfn);
