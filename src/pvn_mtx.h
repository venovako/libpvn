...
PVN_EXTERN_C int pvn_rvis_stop_f(pvn_rvis_ctx_f *const ctx, const unsigned sx, const unsigned sy, const unsigned bpp, const char *const bnB);
PVN_EXTERN_C int pvn_rvis_stop(pvn_rvis_ctx *const ctx, const unsigned sx, const unsigned sy, const unsigned bpp, const char *const bnB);
PVN_EXTERN_C int pvn_rvis_stop_l(pvn_rvis_ctx_l *const ctx, const unsigned sx, const unsigned sy, const unsigned bpp, const char *const bnB);
