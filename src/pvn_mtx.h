...
PVN_EXTERN_C int pvn_rvis_stop_f_(pvn_rvis_ctx_f **const ctx, const unsigned *const sx, const unsigned *const sy, const unsigned *const bppB, const char *const bnB, ...);
...
PVN_EXTERN_C int pvn_rvis_stop_(pvn_rvis_ctx **const ctx, const unsigned *const sx, const unsigned *const sy, const unsigned *const bppB, const char *const bnB, ...);
...
PVN_EXTERN_C int pvn_rvis_stop_l_(pvn_rvis_ctx_l **const ctx, const unsigned *const sx, const unsigned *const sy, const unsigned *const bppB, const char *const bnB, ...);
...
PVN_EXTERN_C int pvn_cvis_stop_f_(pvn_cvis_ctx_f **const ctx, const unsigned *const sx, const unsigned *const sy, const unsigned *const bppB, const char *const bnB, const unsigned *const bppC, const char *const bnC, ...);
...
PVN_EXTERN_C int pvn_cvis_stop_(pvn_cvis_ctx **const ctx, const unsigned *const sx, const unsigned *const sy, const unsigned *const bppB, const char *const bnB, const unsigned *const bppC, const char *const bnC, ...);
...
PVN_EXTERN_C int pvn_cvis_stop_l_(pvn_cvis_ctx_l **const ctx, const unsigned *const sx, const unsigned *const sy, const unsigned *const bppB, const char *const bnB, const unsigned *const bppC, const char *const bnC, ...);
