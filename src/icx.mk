...
CFLAGS += -D_GNU_SOURCE -D_LARGEFILE64_SOURCE -std=gnu18 -fPIC -fexceptions -fp-model precise -fprotect-parens -fma -no-ftz -qopenmp-simd -pthread -fno-omit-frame-pointer -traceback -xHost #-qopenmp
