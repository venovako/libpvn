...
PVN_EXTERN_C void pvn_snrm2o_(const unsigned *const m, const unsigned *const n, float *const g, const unsigned *const ldg, double *const ssq, int *const info);
PVN_EXTERN_C void pvn_dnrm2o_(const unsigned *const m, const unsigned *const n, double *const g, const unsigned *const ldg, long double *const ssq, int *const info);
#ifdef PVN_QUADMATH
