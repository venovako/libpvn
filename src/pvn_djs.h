...
#endif /* ?PVN_QUADMATH */
PVN_EXTERN_C void pvn_djs_xmkd_(const unsigned *const n, const double *const g, const unsigned *const ldg, long double *const d, const unsigned *const o, int *const info);
PVN_EXTERN_C void pvn_djs_wmkd_(const unsigned *const n, const double complex *const g, const unsigned *const ldg, long double *const d, const unsigned *const o, int *const info);
